...
model = pickle.load(open('/content/drive/My Drive/midTerm.pkl','rb'))

dataset = pd.read_csv('rahul PIET18CS114 - Classification Dataset1.csv')
...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: RAHUL CHHABLANI</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;">|| PIET18CS114 || Sec: C || Roll No 4 ||</p></center>
   </div>
   </div>
   </div>
   """
